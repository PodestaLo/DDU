...
public class ContextUtil {
	...
	*//**
	...
	public static String getCurrentUserSkin(){
		...
		String skinStyle="";
		ResourceBundle rb=ResourceBundle.getBundle("run");
		String runMode = rb.getString("runMode");
		if("dev".equalsIgnoreCase(runMode))
		{
			skinStyle=rb.getString("devStyle");
		}else 
		{
			skinStyle=rb.getString("publicStyle");
		}
