package com.podesta.ddu.bk.core.web;
...
import com.podesta.ddu.bk.core.page.PageUtils;
import com.podesta.ddu.bk.core.web.util.RequestUtil;
...
//	private ParamEncoder paramEncoder;
	 ...
	 * 如果需要碰到需要分页的情况，	请{@link com.podesta.ddu.bk.core.web.util.hotent.core.web.util.RequestUtil#getQueryMap(HttpServletRequest) 参考}定义的参数规格。
	 * 
