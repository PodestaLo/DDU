package com.podesta.ddu.bk.core.page;
 ...
 * 第一页从1开始
 */
//@XmlAccessorType(XmlAccessType.PUBLIC_MEMBER) 此处作用未知 20170421
public class PageBean implements Serializable
{
	private static final long serialVersionUID = -1456574318841509116L;
	/**
	 * 显示页数
	 */
	public static Integer SHOW_PAGES=6;
	/**
	 * 缺省的页大小 TODO 默认为15，现改为2
	 */
